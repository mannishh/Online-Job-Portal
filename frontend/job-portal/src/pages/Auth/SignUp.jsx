      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-linear-to-r from-pink-400 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-pink-500 hover:to-purple-700 disabled:hover:from-pink-400 disabled:hover:to-purple-600 transition-all duration-300 cursor-pointer disabled:cursor-default disabled:opacity-50 flex items-center justify-center space-x-2"
          >
            {formState.loading ? (
              <>
