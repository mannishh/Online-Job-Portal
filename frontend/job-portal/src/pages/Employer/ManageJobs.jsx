...
const ManageJobs = () => {
  ...
  const handleStatusChange = async (jobId) => {
    try {
      ...
      console.error("Error togging job status:", error);
    }
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-row items-center justify-between">
              ...
              <button
                className="inline-flex items-center px-6 py-3 bg-linear-to-r from-pink-600 to-pink-700 hover:from-pink-700 hover:to-pink-800 text-sm text-white font-semibold rounded-xl shadow-lg shadow-pink-500/25 hover:shadow-xl hover:shadow-pink-500/30 transition-all duration-300 transform hover:-translate-y-0.5 whitespace-nowrap cursor-pointer "
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-500/20 focus:border-pink-500 outline-0 transition-all duration-200 bg-gray-50/50 placeholder-gray-400"
                />
              </div>
              ...
              <div className="sm:w-48">
                <select
                  ...
                  className="block w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-pink-500/2 focus:border-pink-500 transition-all duration-200"
                >
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {isLoading
                        ...
                        : paginatedJobs.map((job) => (
                            <tr
                              key={job.id}
                              className="hover:bg-pink-50/30 transition-all duration-200 border-b border-gray-100/60"
                            >
                              <td className="px-6 py-5 whitespace-nowrap min-w-[200px] sm:min-w-0">
                                <div>
                                  ...
                                  <div className="text-x text-gray-500 font-medium">
                                    {job.company}
                                  </div>
                                </div>
                              </td>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium min-w-[180px] sm:min-w-0">
                                <div className="flex space-x-2">
                                  <button
                                    className="text-blue-600 hover:text-blue-800 p-2 rounded-lg hover:bg-pink-50 transition-colors duration-200 cursor-pointer"
                                    onClick={() =>
                                      navigate("/post-job", {
                                        state: { jobId: job.id },
                                      })
                                  ...
                                  {job.status === "Active" ? (
                                    <button
                                      ...
                                      className="flex items-center gap-2 text-xs text-orange-600 hover:text-orange-800 p-2 rounded-lg hover:bg-orange-50 transition-colors duration-200 cursor-pointer"
                                    >
                                      <X className="w-4 h-4" />
                                    ...
                                    <button
                                      onClick={() => handleStatusChange(job.id)}
                                      className="flex items-center gap-2 text-xs text-green-600 hover:text-green-800 p-2 rounded-lg hover:bg-green-50 transition-colors duration-200 cursor-pointer"
                                    >
                                  ...
                                  <button
                                    ...
                                    className="text-red-600 hover:text-red-800 p-2 rounded-lg hover:bg-red-50 transition-colors duration-200 cursor-pointer"
                                  >
