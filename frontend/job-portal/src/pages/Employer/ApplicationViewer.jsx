                    ...
                    <div className="bg-linear-to-r from-pink-500 to-pink-600 px-6 py-4">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-4 mt-2 text-pink-100">
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3 mt-4 md:m-0">
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-2 px-3 py-2 bg-pink-600 text-white text-sm font-medium rounded-lg hover:bg-pink-700 transition-colors cursor-pointer"
                              >
