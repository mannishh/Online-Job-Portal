...
const JobPostingForm = () => {
  ...
  const handleInputChange = (field, value) => {
    ...
    // Clear salary error when either salary field is changed
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.salaryMin || !formData.salaryMax) {
      errors.salary = "Both min. and max. salary are required";
    } else {
  ...
  return (
    <DashboardLayout activeMenu="post-job">
      <div className="min-h-screen bg-linear-to-br from-slate-50 via-pink-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                      <TbCurrencyRupeeNepalese className="h-5 w-5 text-gray-400" />
                    </div>
                    <input
                      placeholder="Min"
                      type="number"
                      ...
                      className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-20 focus:border-pink-500 transition-colors duration-200"
                    />
                  </div>
              ...
              <div className="pt-2">
                <button
                  ...
                  className={`w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-pink-600 hover:bg-pink-700 focus:outline-none focus:ring-offset-2 focus:ring-pink-500 disabled:opacity-60 disabled:hover:bg-pink-600 disabled:hover:opacity-60 outline-none transition-all duration-200 ${
