            ...
            <div className="relative px-0 pb-8 border-b border-gray-100">
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-pink-50 text-sm text-pink-700 font-semibold rounded-full border border-pink-200">
                    {jobDetails.category}
                  </span>
            ...
            <div className="px-0 pb-8 space-y-8">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="p-3 bg-linear-to-r from-emerald-500 to-teal-500 rounded-xl">
                        <TbCurrencyRupeeNepalese className="h-6 w-6 text-white" />
                      </div>
                      <div>
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                  <div className="w-1 h-8 bg-linear-to-b from-pink-500 to-purple-600 rounded-full"></div>
