...
const UserProfile = () => {
  ...
  return (
    <div className="bg-linear-to-br from-pink-50 via-white to-purple-50">
      <Navbar />
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 mt-16 lg:m-20">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            {/* Header */}
            <div className="bg-linear-to-r from-pink-500 to-pink-600 px-8 py-6 flex justify-between items-center">
