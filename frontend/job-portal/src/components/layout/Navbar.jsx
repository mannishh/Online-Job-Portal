        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to='/find-jobs' className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-linear-to-r from-pink-500 to-pink-600 rounded-lg flex items-center justify-center">
                <Briefcase className="w-5 h-5 text-white"/>
              </div>
              <span className="text-lg font-bold text-gray-900">RojGaar</span>
            </Link>
              ...
              {isAuthenticated ? (
                ...
                <a
                 ...
                 >
                  ...
                  <a 
                  href="/signup"
                  className="bg-linear-to-r from-pink-600 to-purple-600 text-white px-6 py-2 rounded-lg font-medium hover:from-pink-700 hover:to-purple-700 transition-all duration-300 shadow-sm hover:shadow-md "
                  >
                    Sign Up
                  </a>
                  </>
