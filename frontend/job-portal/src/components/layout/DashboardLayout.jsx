  ...
  return (
    <button
      ...
      className={`w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 group cursor-pointer ${
        isActive
          ? "bg-pink-50 text-pink-700 shadow-sm shadow-pink-50"
...
const DashboardLayout = ({ activeMenu, children }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      >
        {/* company logo */}
        <div className="flex items-center h-16 border-gray-200 pl-6">
          {!sidebarCollapsed ? (
            <Link className="flex items-center space-x-3" to="/">
              <div className="h-8 w-8 bg-linear-to-br from-pink-600 to-pink-700 rounded-lg flex items-center justify-center ">
                <Briefcase className="h-5 w-5 text-white" />
              </div>
              <span className="text-gray-900 font-bold text-xl">RojGaar</span>
            </Link>
          ) : (
            <div className="h-8 w-8 bg-linear-to-br from-pink-600 to-pink-700 rounded-xl flex items-center justify-center ">
